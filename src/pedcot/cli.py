...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="pedcot", description="PedCoT reproduction CLI.")
    ...
    run_parser = subparsers.add_parser("run", help="Run PedCoT inference.")
    ...
    evaluate_parser = subparsers.add_parser("evaluate", help="Evaluate saved PedCoT predictions.")
